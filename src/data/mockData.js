...
export const getNavItemsForRole = (role) => {
    const allItems = [
        { path: '/', labelKey: 'dashboard', icon: 'LayoutDashboard', roles: ['ADMIN', 'MANAGER', 'EMPLOYEE'] },
        { path: '/customers', labelKey: 'customers', icon: 'Users', roles: ['ADMIN', 'MANAGER'] },
        { path: '/leads', labelKey: 'leads', icon: 'Target', roles: ['ADMIN', 'MANAGER'] },
        { path: '/products', labelKey: 'products', icon: 'Package', roles: ['ADMIN', 'MANAGER'] },
        { path: '/assets', labelKey: 'assets', icon: 'FolderOpen', roles: ['ADMIN', 'MANAGER'] },
        { path: '/orders', labelKey: 'orders', icon: 'ShoppingCart', roles: ['ADMIN', 'MANAGER'] },
        { path: '/tasks', labelKey: 'tasks', icon: 'CheckSquare', roles: ['ADMIN', 'MANAGER', 'EMPLOYEE'] },
        { path: '/workflows', labelKey: 'workflows', icon: 'GitBranch', roles: ['ADMIN', 'MANAGER'] },
        { path: '/departments', labelKey: 'departments', icon: 'Building2', roles: ['ADMIN', 'MANAGER'] },
        { path: '/parameters', labelKey: 'parameters', icon: 'Sliders', roles: ['ADMIN', 'MANAGER'] },
        { path: '/import', labelKey: 'import', icon: 'Upload', roles: ['ADMIN', 'MANAGER'] },
        { path: '/calendar', labelKey: 'calendar', icon: 'Calendar', roles: ['ADMIN', 'MANAGER', 'EMPLOYEE'] },
        { path: '/analytics', labelKey: 'analytics', icon: 'BarChart3', roles: ['ADMIN', 'MANAGER'] },
        { path: '/users', labelKey: 'users', icon: 'UserCog', roles: ['ADMIN'] },
        { path: '/settings', labelKey: 'settings', icon: 'Settings', roles: ['ADMIN', 'MANAGER', 'EMPLOYEE'] }
    ];
